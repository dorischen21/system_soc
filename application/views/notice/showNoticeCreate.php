			...
			<form method='post' id='form1'>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-5">
							<input name='txt_srcIp' type='text' id='txt_srcIp' class='form-control' pattern="[^\^\`\~\!\@\#\$\%\^\&\*\(\)\_\+\-\=\[\]\\\;\'\/'\{\}\|\:\<\>\?]{1,40}" required>
						</div>
						<div class="col-md-1" style="padding-left: 0px; padding-right: 0px;">
							<h5>來源PORT</h5>
						</div>
						<div class="col-md-5">
							<input name='txt_srcPort' type='text' id='txt_srcPort' class='form-control' pattern="[^\^\`\~\!\@\#\$\%\^\&\*\(\)\_\+\=\[\]\\\;\'\.\/'\{\}\|\:\<\>\?]{1,40}" required>
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-5">
							<input name='txt_dstIp' type='text' id='txt_dstIp' class='form-control' pattern="[^\^\`\~\!\@\#\$\%\^\&\*\(\)\_\+\-\=\[\]\\\;\'\/'\{\}\|\:\<\>\?]{1,40}" required>
						</div>
						<div class="col-md-1" style="padding-left: 0px; padding-right: 0px;">
							<h5>目標PORT</h5>
						</div>
						<div class="col-md-5">
							<input name='txt_dstPort' type='text' id='txt_dstPort' class='form-control' pattern="[^\^\`\~\!\@\#\$\%\^\&\*\(\)\_\+\=\[\]\\\;\'\.\/'\{\}\|\:\<\>\?]{1,40}" required>
						</div>
					</div>
				</div>
				<div class="form-group">
