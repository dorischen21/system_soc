		...
		<div class='container'>
			<form method='post' id='form1'>
				<input type='hidden' id='hid_companyId' name='hid_companyId' value='<?= $ary_editnotice[$notice_id]['company_id'] ?>'>
				<div class="row">
					<h1><?= $title ?></h1>
					<h1></h1>
				</div>
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-5">
							<input name='txt_dstIp' type='text' id='txt_dstIp' class='form-control' value='<?= $ary_editnotice[$notice_id]['dst_ip'] ?>' required <?= ((strval($isEditable) == '1') && ($this->session->userdata('role') == ROLE_ADMIN)) ? '' : 'readonly' ?> pattern="[0-9.,、-]{1,40}" required>
						</div>
						<div class="col-md-1" style="padding-left: 0px; padding-right: 0px;">
							<h5>目標PORT</h5>
						</div>
						<div class="col-md-5">
							<input name='txt_dstPort' type='text' id='txt_dstPort' class='form-control' value='<?= $ary_editnotice[$notice_id]['dst_port'] ?>' required <?= ((strval($isEditable) == '1') && ($this->session->userdata('role') == ROLE_ADMIN)) ? '' : 'readonly' ?> pattern="[0-9.,、-]{1,40}" required>
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-5">
							<input name='txt_srcIp' type='text' id='txt_srcIp' class='form-control' value='<?= $ary_editnotice[$notice_id]['src_ip'] ?>' required <?= ((strval($isEditable) == '1') && ($this->session->userdata('role') == ROLE_ADMIN)) ? '' : 'readonly' ?> pattern="[0-9.,、-]{1,40}" required>
						</div>
						<div class="col-md-1" style="padding-left: 0px; padding-right: 0px;">
							<h5>來源PORT</h5>
						</div>
						<div class="col-md-5">
							<input name='txt_srcPort' type='text' id='txt_srcPort' class='form-control' value='<?= $ary_editnotice[$notice_id]['src_port'] ?>'required <?= ((strval($isEditable) == '1') && ($this->session->userdata('role') == ROLE_ADMIN)) ? '' : 'readonly' ?> pattern="[0-9.,、-]{1,40}" required>
						</div>
					</div>
				</div>
				<div class="form-group">
					<div class="row">
						...
						<div class="col-md-5">
							<textarea rows="3" name='txt_srcIp2' type='text' id='txt_srcIp2' class='form-control' maxlength='255' <?= ((strval($isEditable) == '1') && (($this->session->userdata('role') == ROLE_ADMIN) or ($this->session->userdata('role') == ROLE_SERVICE))) ? '' : 'readonly' ?>><?= $ary_editnotice[$notice_id]['src_ip2'] ?></textarea>
						</div>
						<div class="col-md-1" style="padding-left: 0px; padding-right: 0px;">
							<h5>事件描述</h5>
						</div>
