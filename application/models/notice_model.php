...
class Notice_model extends CI_Model {
	...
	public function editNotice($id) {
		...
		$this->db->select('id, company_id, type, name, create_date, src_ip, src_port, dst_ip, dst_port, level, count, description, advise, note, m_service_id, number, email, projectname, customer_id, bccs, subject, end_date');
		$this->db->where('id', $id); 
